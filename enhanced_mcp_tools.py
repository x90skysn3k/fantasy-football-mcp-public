...
def _enhance_player_data(player: Player) -> EnhancedPlayerData:
    ...
    return EnhancedPlayerData(
        ...
        sleeper_projection_std=getattr(player, 'sleeper_projection_std', 0.0),
        sleeper_projection_ppr=getattr(player, 'sleeper_projection_ppr', 0.0),
        sleeper_projection_half_ppr=getattr(player, 'sleeper_projection_half_ppr', 0.0),
        sleeper_id=getattr(player, 'sleeper_id', ''),
        sleeper_status=getattr(player, 'sleeper_status', ''),
        sleeper_injury_status=getattr(player, 'sleeper_injury_status', ''),
        sleeper_match_method=getattr(player, 'sleeper_match_method', ''),
