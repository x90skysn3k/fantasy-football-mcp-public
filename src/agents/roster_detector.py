...
class RosterDetector:
    ...
    async def detect_league_roster(self, league_key: str) -> List[RosterPosition]:
        ...
        try:
            ...
            logger.info(
                f"Detected roster for {league_key}: {self._summarize_roster(roster_positions)}"
            )
                                    ...
                                    if isinstance(roster_data, list):
                                        for pos_item in roster_data:
                                            if (
                                                ...
                                                and "roster_position" in pos_item
                                            ):
    ...
    async def detect_all_league_rosters(
        self, league_keys: List[str]
    ) -> Dict[str, List[RosterPosition]]:
        """
    ...
    def can_start_player(self, league_key: str, player_position: str, roster_slot: str) -> bool:
        """
