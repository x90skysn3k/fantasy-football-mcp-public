...
class GameEnvironment(BaseModel):
    ...
    weather_impact_score: Optional[Decimal] = Field(
        ...
        ge=0, 
        le=10, 
        description="Weather impact on fantasy (0=none, 10=severe)"
    )
...
class TeamStats(BaseModel):
    ...
    passing_yards_per_game: Optional[Decimal] = Field(None, ge=0, description="Passing yards per game")
    rushing_yards_per_game: Optional[Decimal] = Field(None, ge=0, description="Rushing yards per game")
    turnovers_per_game: Optional[Decimal] = Field(None, ge=0, description="Turnovers per game")
    
    # Defensive stats
    points_allowed_per_game: Optional[Decimal] = Field(None, ge=0, description="Points allowed per game")
    yards_allowed_per_game: Optional[Decimal] = Field(None, ge=0, description="Yards allowed per game")
    passing_yards_allowed_per_game: Optional[Decimal] = Field(None, ge=0, description="Passing yards allowed")
    rushing_yards_allowed_per_game: Optional[Decimal] = Field(None, ge=0, description="Rushing yards allowed")
    ...
    red_zone_efficiency: Optional[Decimal] = Field(
        ...
        ge=0, 
        le=100, 
        description="Red zone scoring percentage"
    )
    ...
    kicking_accuracy: Optional[Decimal] = Field(
        ...
        ge=0, 
        le=100, 
        description="Field goal accuracy percentage"
    )
...
class BettingLine(BaseModel):
    ...
    home_win_probability: Optional[Decimal] = Field(
        ...
        ge=0, 
        le=1, 
        description="Implied home win probability"
    )
    away_win_probability: Optional[Decimal] = Field(
        None, 
        ge=0, 
        le=1, 
        description="Implied away win probability"
    )
    ...
    public_bet_percentage_spread: Optional[Decimal] = Field(
        ...
        ge=0, 
        le=100, 
        description="Public betting percentage on spread"
    )
    public_bet_percentage_total: Optional[Decimal] = Field(
        None, 
        ge=0, 
        le=100, 
        description="Public betting percentage on over"
    )
...
class HistoricalMatchup(BaseModel):
    ...
    # Fantasy relevance
    avg_passing_yards_home: Optional[Decimal] = Field(None, description="Home team avg passing yards")
    avg_rushing_yards_home: Optional[Decimal] = Field(None, description="Home team avg rushing yards")
    avg_passing_yards_away: Optional[Decimal] = Field(None, description="Away team avg passing yards")
    avg_rushing_yards_away: Optional[Decimal] = Field(None, description="Away team avg rushing yards")
...
class Matchup(BaseModel):
    ...
    game_environment: Optional[GameEnvironment] = Field(None, description="Game environment conditions")
    
    # Betting information
    betting_lines: Optional[BettingLine] = Field(None, description="Betting lines and odds")
    
    # Historical context
    historical_matchup: Optional[HistoricalMatchup] = Field(None, description="Historical head-to-head data")
    
    # Projections
    projected_home_score: Optional[Decimal] = Field(None, ge=0, description="Projected home team score")
    projected_away_score: Optional[Decimal] = Field(None, ge=0, description="Projected away team score")
    projected_total_points: Optional[Decimal] = Field(None, ge=0, description="Projected total points")
    ...
    fantasy_relevance_score: Optional[Decimal] = Field(
        ...
        ge=0, 
        le=10, 
        description="Fantasy relevance score (0-10)"
    )
...
class MatchupFactor(BaseModel):
    ...
    impact_rating: Decimal = Field(
        ..., 
        ge=-5, 
        le=5, 
        description="Impact rating (-5 to +5)"
    )
...
class TeamAnalysis(BaseModel):
    ...
    volume_expectations: Dict[str, str] = Field(
        ..., 
        description="Expected volume by position"
    )
...
class MatchupAnalysis(BaseModel):
    ...
    home_win_probability: Decimal = Field(
        ...
        ge=0, 
        le=1, 
        description="Predicted home team win probability"
    )
    away_win_probability: Decimal = Field(
        ..., 
        ge=0, 
        le=1, 
        description="Predicted away team win probability"
    )
    ...
    competitiveness_rating: Decimal = Field(
        ...
        ge=0, 
        le=10, 
        description="Expected game competitiveness (0-10)"
    )
    ...
    value_bets: Optional[List[str]] = Field(None, description="Potential value betting opportunities")
    ...
    volatility_rating: Decimal = Field(
        ...
        ge=0, 
        le=10, 
        description="Expected outcome volatility (0-10)"
    )
