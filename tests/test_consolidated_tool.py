...
async def test_all_data_levels():
    ...
    try:
        ...
        for level in data_levels:
            ...
            result = await call_tool("ff_get_roster", {
                    ...
                    if data["status"] == "success":
                        ...
                        if level == "basic":
                            ...
                            if "players_by_position" in data:
                                ...
                                pos_summary = ", ".join([f"{pos}:{len(players)}" for pos, players in positions.items()])
...
async def test_backward_compatibility():
    ...
    try:
        ...
        result = await call_tool("ff_get_roster_with_projections", {
