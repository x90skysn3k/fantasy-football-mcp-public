...
def create_sample_players() -> List[Player]:
    ...
    josh_allen = Player(
        ...
        projections=PlayerProjections(
            ...
            projected_stats=PlayerStats(
                passing_yards=280, passing_touchdowns=2, rushing_yards=45, rushing_touchdowns=1
            ),
    ...
    cmc = Player(
        ...
        projections=PlayerProjections(
            ...
            projected_stats=PlayerStats(
                rushing_yards=95, rushing_touchdowns=1, receptions=6, receiving_yards=45
            ),
    ...
    austin_ekeler = Player(
        ...
        projections=PlayerProjections(
            ...
            projected_stats=PlayerStats(
                rushing_yards=75, rushing_touchdowns=1, receptions=5, receiving_yards=35
            ),
    ...
    cooper_kupp = Player(
        ...
        projections=PlayerProjections(
            ...
            projected_stats=PlayerStats(
                targets=10, receptions=7, receiving_yards=95, receiving_touchdowns=1
            ),
            confidence_score=Decimal("0.85"),
            projection_source="Sleeper",
            last_updated="2024-01-01T00:00:00Z",
    ...
    tyreek_hill = Player(
        ...
        projections=PlayerProjections(
            ...
            projected_stats=PlayerStats(
                targets=9, receptions=6, receiving_yards=85, receiving_touchdowns=1
            ),
            confidence_score=Decimal("0.80"),
            projection_source="Yahoo",
            last_updated="2024-01-01T00:00:00Z",
    ...
    travis_kelce = Player(
        ...
        projections=PlayerProjections(
            ...
            projected_stats=PlayerStats(
                targets=8, receptions=6, receiving_yards=75, receiving_touchdowns=1
            ),
            confidence_score=Decimal("0.85"),
            projection_source="Sleeper",
            last_updated="2024-01-01T00:00:00Z",
    ...
    bills_def = Player(
        ...
        projections=PlayerProjections(
            ...
            projected_stats=PlayerStats(
                sacks=3, interceptions_def=1, fumble_recoveries=1, points_allowed=17
            ),
            confidence_score=Decimal("0.80"),
            projection_source="Sleeper",
            last_updated="2024-01-01T00:00:00Z",
...
async def basic_optimization_example():
    ...
    assistant = await create_fantasy_assistant(
        llm_api_key=os.getenv("OPENAI_API_KEY", "your-api-key-here"), enable_llm=True
    )
...
async def interactive_questioning_example():
    ...
    result = await assistant.optimize_lineup(
        players=players, constraints=constraints, strategy=OptimizationStrategy.BALANCED
    )
...
async def strategy_comparison_example():
    ...
    for strategy in strategies:
        ...
        result = await assistant.optimize_lineup(
            players=players, constraints=constraints, strategy=strategy
        )
...
async def performance_monitoring_example():
    ...
    print(
        f"Average optimization time: {stats['session_stats']['average_optimization_time']:.2f} seconds"
    )
    print(
        f"Average interaction time: {stats['session_stats']['average_interaction_time']:.2f} seconds"
    )
    ...
    print(
        f"Average response time: {stats['interaction_stats']['average_response_time']:.2f} seconds"
    )
