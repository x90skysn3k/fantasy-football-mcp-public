...
if response.status_code == 200:
    ...
    # Also update the main Claude config (if available)
    import platform
    system = platform.system()
    if system == 'Darwin':  # macOS
        main_config_path = os.path.expanduser('~/Library/Application Support/Claude/claude_desktop_config.json')
    elif system == 'Windows':
        main_config_path = os.path.expandvars('%APPDATA%\\Claude\\claude_desktop_config.json')
    else:  # Linux
